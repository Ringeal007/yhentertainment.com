                                        ...
                                        <div class="resume-block">
                                            ...
                                            <p>
                                                ...
                                                <ul>
                                                    ...
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-CPU-1-2'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-2-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-2-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-2-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-2-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-2-5'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-2-6'] ?? ''); ?></li>
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-CPU-1-3'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-3-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-3-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-3-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-3-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-3-5'] ?? ''); ?></li>
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-CPU-1-4'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-4-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-4-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-4-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-4-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-4-5'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-CPU-1-4-6'] ?? ''); ?></li>
                                                </ul>
                                                <blockquote>
                                                ...
                                                <ul>
                                                    ...
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-GPU-1-2'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-2-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-2-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-2-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-2-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-2-5'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-2-6'] ?? ''); ?></li>
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-GPU-1-3'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-3-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-3-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-3-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-3-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-3-5'] ?? ''); ?></li>
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-GPU-1-4'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-4-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-4-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-4-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-4-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-4-5'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-GPU-1-4-6'] ?? ''); ?></li>
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-GPU-1-5'] ?? ''); ?></p>
                                                ...
                                                <ul>
                                                    ...
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-Mb-2'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-2-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-2-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-2-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-2-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-2-5'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-2-6'] ?? ''); ?></li>
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-Mb-3'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-5'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-6'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-7'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-8'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-3-9'] ?? ''); ?></li>
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-Mb-4'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-4-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-4-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-4-3'] ?? ''); ?></li>
                                                    <br \><br \>
                                                    <p style="font-weight: bold"><?php echo htmlspecialchars($lang['article003-Mb-5'] ?? ''); ?></p>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-5-1'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-5-2'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-5-3'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-5-4'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-5-5'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-5-6'] ?? ''); ?></li>
                                                    <li><?php echo htmlspecialchars($lang['article003-Mb-5-7'] ?? ''); ?></li>
                                                </ul>
                                                <h3 style="text-align: center;"><?php echo htmlspecialchars($lang['to-be-continued'] ?? ''); ?></h3>
                                        </div> <!-- end resume-block -->
                                    </div>
